...
//// view red
////
//// view red is the bad guy's view or public IP.
////
...
view "red"
{
    ...
    zone "example.net" IN 
    {
        ...
        file "/var/lib/bind/view.red.example.net";
        ...
        journal "/var/cache/bind/view.red.example.net.jnl";

        //// update-policy is detailed in 
        //// http://www.zytrax.com/books/dns/ch7/xfer.html#update-policy
        //update-policy { grant "local-ddns" name srv.example.net A; };
        update-policy local;
        ...
        //// following policy.
        allow-transfer { secondary_nameservers; };
    };
